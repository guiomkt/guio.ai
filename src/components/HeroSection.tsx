          ...
          <div className="md:w-1/2 mb-8 md:mb-0 order-2 md:order-1">
            <div className="space-y-4 md:space-y-6">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="text-guio-white">Escale sua operação </span>
                <span className="text-guio-white block mt-1 sm:mt-2">sem aumentar sua equipe. </span>
                <span className="text-gradient-red block">
                  <TypewriterEffect text="Agentes de IA" delay={100} />
                </span>
                <span className="text-guio-white block">trabalhando 24/7 pela sua empresa.</span>
              </h1>
